...
public class DiscordEventHandlers extends Structure
{
    ...
    private static final List<String> FIELD_ORDER = List.of("ready", "disconnected", "errored", "joinGame", "spectateGame", "joinRequest");
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof DiscordEventHandlers that))
            return false;
